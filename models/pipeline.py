...
class Pipeline:
    ...
    def transform_data(news_site_uid):
        ...
        DataWrangling(Pipeline.get_output_file(news_site_uid), news_site_uid)

    @staticmethod
    def get_output_file(news_site_uid):
    ...
    def save_articles(news_site_uid, articles):
        ...
        print(csv_headers)
        with open(Pipeline.get_output_file(news_site_uid), mode='w+', encoding='utf-8') as f:
            writer = csv.writer(f)
